...
while True:
    ...
    for robot in globals.ROBOTS:
        ...
        VISUALIZER.draw(robot.position, robot.color, cnt,
                        robot.path, collision_box, (proximity_sensors_state[0], 0, proximity_sensors_state[1], 0, proximity_sensors_state[2]), robot.DRAW_proximity_sensor_position, DRAW_bottom_sensor_position, bottom_sensor_states, PHEROMON_PATH)
        decay_check()
        if cnt % 2 == 0:
